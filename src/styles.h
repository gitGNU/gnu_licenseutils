...
*/
#ifndef LU_STYLES_H
#define LU_STYLES_H 1

#include "comment-style.h"

extern struct argp styles_argp;
struct lu_comment_style_t * get_default_commenting_style();
struct lu_comment_style_t * lu_lookup_comment_style (char *arg);
