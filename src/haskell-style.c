...
{
    {"haskell-style", OPT_HASKELL, NULL, 0, 
      N_("haskell style comments  e.g. {- foo -}")},
    {0},
};
...
struct argp haskell_style_argp = { argp_options, parse_opt, "", "", 0};
...
struct lu_comment_style_t haskell_style=
{
  .name                = "haskell",
  .argp                = &haskell_style_argp,
