...
struct argp cplusplus_style_argp = { argp_options, parse_opt, "", "", 0};
...
struct lu_comment_style_t cplusplus_style=
{
  .name                = "c++",
  .argp                = &cplusplus_style_argp,
